...
const blogPosts = {
  ...
  'clean-catalog': {
    ...
    date: "2024-03-20",
    content: `
      <h2>مقدمة شاملة عن خدمات النظافة في الرياض</h2>
      <p>تعرف على جميع خدمات النظافة المتاحة في الرياض من تنظيف المنازل والمكاتب إلى السجاد والخزانات والتعقيم الشامل.</p>
      
      <h2>خدمات تنظيف المنازل</h2>
      <p>المنزل النظيف يعكس راحة العائلة وصحتها، ويتطلب عناية خاصة ومحترفة.</p>
      
      <h2>تنظيف المكاتب والشركات</h2>
      <p>بيئة العمل النظيفة تعزز الإنتاجية وتحافظ على صحة الموظفين.</p>
      
      <h2>خدمات متخصصة</h2>
      <p>تشمل تنظيف السجاد والموكيت، تنظيف الخزانات، والتعقيم الشامل لضمان بيئة صحية آمنة.</p>
    `,
    imageUrl: "/comprehensive-cleaning-services.avif",
    author: "فريق شركة النظافة العصرية"
  },
